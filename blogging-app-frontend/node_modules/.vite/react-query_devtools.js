...
var init_match_sorter_esm = __esm({
  "node_modules/match-sorter/dist/match-sorter.esm.js"() {
    init_extends();
    import_remove_accents = __toModule(require_remove_accents());
    rankings = {
...
var require_devtools = __commonJS({
  "node_modules/react-query/lib/devtools/devtools.js"(exports) {
    ...
    var _objectWithoutPropertiesLoose2 = _interopRequireDefault(require_objectWithoutPropertiesLoose());
    var _react = _interopRequireDefault(require_react());
    var _reactQuery = (init_es(), es_exports);
    var _matchSorter = (init_match_sorter_esm(), match_sorter_esm_exports);
    ...
    function ReactQueryDevtools(_ref) {
      ...
      _react.default.useEffect(function() {
        ...
        if (ref) {
          let handlePanelTransitionStart = function() {
            if (ref && isResolvedOpen) {
              ref.style.visibility = "visible";
            }
          }, handlePanelTransitionEnd = function() {
            if (ref && !isResolvedOpen) {
    ...
    var ReactQueryDevtoolsPanel = _react.default.forwardRef(function ReactQueryDevtoolsPanel2(props, ref) {
      ...
      var isOpen = props.isOpen, setIsOpen = props.setIsOpen, handleDragStart = props.handleDragStart, panelProps = (0, _objectWithoutPropertiesLoose2.default)(props, ["isOpen", "setIsOpen", "handleDragStart"]);
      ...
      return _react.default.createElement(_theme.ThemeProvider, {
        ...
        }, query.getObserversCount()), _react.default.createElement(_styledComponents.Code, {
          suppressHydrationWarning: true,
          style: {
            padding: ".5rem"
          }
