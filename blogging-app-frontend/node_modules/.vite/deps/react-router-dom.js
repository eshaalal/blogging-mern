...
function createBrowserHistory(a) {
  ...
  function g(a2) {
    return "string" === typeof a2 ? a2 : E(a2);
  }
  function t2(a2, d) {
    void 0 === d && (d = null);
    return y(_extends({}, l2, {}, "string" === typeof a2 ? F(a2) : a2, { state: d, key: D() }));
  }
  function v3(a2) {
    n2 = a2;
    a2 = b();
  ...
  void 0 === a && (a = {});
  a = a.window;
  var h = void 0 === a ? document.defaultView : a, f2 = h.history, p3 = null;
  ...
  null == q3 && (q3 = 0, f2.replaceState(_extends({}, f2.state, { idx: q3 }), ""));
  return { get action() {
    return n2;
  }, get location() {
    return l2;
...
function createHashHistory(a) {
  function b() {
    ...
    a2 = a2.hash;
    var e2 = p3.state || {};
    return [e2.idx, y({ pathname: void 0 === c2 ? "/" : c2, search: void 0 === b2 ? "" : b2, hash: void 0 === a2 ? "" : a2, state: e2.usr || null, key: e2.key || "default" })];
  }
  function g() {
    if (n2)
      k2.call(n2), n2 = null;
  ...
  function t2(a2) {
    ...
    d && d.getAttribute("href") && (d = f2.location.href, c2 = d.indexOf("#"), c2 = -1 === c2 ? d : d.slice(0, c2));
    return c2 + "#" + ("string" === typeof a2 ? a2 : E(a2));
  }
  function v3(a2, b2) {
    void 0 === b2 && (b2 = null);
    return y(_extends({}, c, {}, "string" === typeof a2 ? F(a2) : a2, { state: b2, key: D() }));
  }
  function w3(a2) {
    q3 = a2;
    a2 = b();
  ...
  function u(a2, c2) {
    ...
    true ? z(
      "/" === e2.pathname.charAt(0),
      "Relative pathnames are not supported in hash history.push(" + JSON.stringify(a2) + ")"
    ) : void 0;
  ...
  void 0 === a && (a = {});
  a = a.window;
  var f2 = void 0 === a ? document.defaultView : a, p3 = f2.history, n2 = null;
  ...
  null == l2 && (l2 = 0, p3.replaceState(_extends({}, p3.state, { idx: l2 }), ""));
  return {
    get action() {
      return q3;
    },
    ...
    block: function(a2) {
      var c2 = k2.push(a2);
      1 === k2.length && f2.addEventListener("beforeunload", A);
      return function() {
        c2();
...
function createMemoryHistory(a) {
  function b(a2, b2) {
    void 0 === b2 && (b2 = null);
    return y(_extends({}, n2, {}, "string" === typeof a2 ? F(a2) : a2, { state: b2, key: D() }));
  }
  function g(a2, b2, f3) {
  ...
  a = r3.initialEntries;
  r3 = r3.initialIndex;
  var h = (void 0 === a ? ["/"] : a).map(function(a2) {
    var b2 = y(_extends({ pathname: "/", search: "", hash: "", state: null, key: D() }, "string" === typeof a2 ? F(a2) : a2));
    ...
    return b2;
  }), f2 = Math.min(Math.max(null == r3 ? h.length - 1 : r3, 0), h.length - 1), p3 = m.Pop, n2 = h[f2], q3 = B(), l2 = B();
  return { get index() {
    return f2;
  }, get action() {
    return p3;
...
function D2(a) {
  a = a.element;
  return void 0 === a ? (0, import_react.createElement)(B2, null) : a;
}
...
function A2() {
  ...
  return (0, import_react.useCallback)(function(d, e) {
    void 0 === e && (e = {});
    c.current ? "number" === typeof d ? a.go(d) : (d = J(d, b), (e.replace ? a.replace : a.push)(d, e.state)) : true ? m2(false, "You should call navigate() in a useEffect, not when your component is first rendered.") : void 0;
  }, [a, b]);
}
function C() {
...
function N(a) {
  return a.map(function(a2) {
    var c = { path: a2.path || "/", caseSensitive: true === a2.caseSensitive, element: a2.element || (0, import_react.createElement)(B2, null) };
...
var y3 = (0, import_react2.forwardRef)(function(a, d) {
  var b = a.onClick, c = a.replace, e = void 0 === c ? false : c, f2 = a.state, g = a.target, m3 = a.to;
  ...
  return (0, import_react2.createElement)("a", Object.assign({}, a, { href: c, onClick: function(a2) {
    b && b(a2);
    a2.defaultPrevented || 0 !== a2.button || g && "_self" !== g || a2.metaKey || a2.altKey || a2.ctrlKey || a2.shiftKey || (a2.preventDefault(), a2 = !!e || E(u) === E(h), k2(m3, { replace: a2, state: f2 }));
  }, ref: d, target: g }));
});
