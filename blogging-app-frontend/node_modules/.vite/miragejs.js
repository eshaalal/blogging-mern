...
var import_lodash4 = __toModule(require_lodash4());
...
// node_modules/miragejs/dist/mirage-esm.js
var import_lodash6 = __toModule(require_lodash6());
var import_lodash7 = __toModule(require_lodash7());
var import_lodash8 = __toModule(require_lodash8());
var import_lodash9 = __toModule(require_lodash9());
var import_lodash10 = __toModule(require_lodash10());
var import_lodash11 = __toModule(require_lodash11());
var import_lodash12 = __toModule(require_lodash12());
var import_lodash13 = __toModule(require_lodash13());
var import_lodash14 = __toModule(require_lodash14());
var import_lodash15 = __toModule(require_lodash15());
var import_lodash16 = __toModule(require_lodash16());
var import_lodash17 = __toModule(require_lodash17());
var import_lodash18 = __toModule(require_lodash18());
var import_lodash19 = __toModule(require_lodash19());
var import_lodash20 = __toModule(require_lodash20());
var import_lodash21 = __toModule(require_lodash21());
...
var Schema = function() {
  ...
  _createClass(Schema2, [{
    ...
    value: function registerModel(type, ModelClass) {
      ...
      ModelClass.prototype.associationKeys = new Set();
      ModelClass.prototype.associationIdKeys = new Set();
...
var Server = function() {
  ...
  _createClass(Server2, [{
    ...
    value: function config() {
      ...
      this.logging = this.logging !== void 0 ? this.logging : void 0;
      ...
      var didOverridePretenderConfig = _config.trackRequests !== void 0 && this.pretender;
    ...
    value: function _defineRouteHandlerHelpers() {
      ...
      [["get"], ["post"], ["put"], ["delete", "del"], ["patch"], ["head"], ["options"]].forEach(function(_ref2) {
        var _ref3 = _slicedToArray(_ref2, 2), verb = _ref3[0], alias = _ref3[1];
    ...
    value: function _mapAssociationsFromAttributes(modelName, attributes) {
      ...
      Object.keys(attributes || {}).filter(function(attr) {
        ...
        if (!overrides[attr]) {
          attributes[foreignKey] = _this8.create.apply(_this8, [association3.modelName].concat(_toConsumableArray(factoryAssociation.traitsAndOverrides))).id;
        }
...
var mirage_esm_default = index;

// dep:miragejs
var miragejs_default = mirage_esm_default;
export {
